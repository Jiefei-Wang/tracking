...
from modules.dlc_pytorch.models.backbones import BACKBONES, BaseBackbone
from modules.dlc_pytorch.models.criterions import (
    CRITERIONS,
    LOSS_AGGREGATORS,
)
from modules.dlc_pytorch.models.heads import BaseHead, HEADS
from modules.dlc_pytorch.models.necks import BaseNeck, NECKS
from modules.dlc_pytorch.models.predictors import PREDICTORS
from modules.dlc_pytorch.models.target_generators import (
    TARGET_GENERATORS,
)
