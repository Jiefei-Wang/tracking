...
from modules.dlc_pytorch.models.predictors.base import (
    BasePredictor,
    PREDICTORS,
)
...
class _UnavailableAssembler:
    @staticmethod
    def empty(*args, **kwargs):
        raise RuntimeError("PartAffinityFieldPredictor is unavailable in standalone isolate runtime.")


inferenceutils = SimpleNamespace(Assembler=_UnavailableAssembler)
