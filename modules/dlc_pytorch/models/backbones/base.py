...
except ImportError:  # pragma: no cover - optional dependency for remote downloads only
    def hf_hub_download(*args, **kwargs):
        raise ImportError(
            "huggingface_hub is required only for downloading pretrained backbone weights. "
